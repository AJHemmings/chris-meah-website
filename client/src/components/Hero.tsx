        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-['Inter'] text-2xl sm:text-3xl lg:text-4xl leading-tight">
              I{" "}
              <span className="ai-glow font-extrabold font-['Space_Grotesk']">
                build
              </span>
              ,
              <span className="text-amber-400 font-extrabold font-['Montserrat']">
                {" "}
                train
              </span>
              , and
              <span className="text-sky-400 font-extrabold italic">
                {" "}
                speak
              </span>{" "}
              about{" "}
              <span className="ai-accent font-['Space_Grotesk'] font-extrabold">
                AI
              </span>
            </h2>
            ...
            <p className="text-lg text-gray-100 max-w-xl font-light leading-relaxed backdrop-blur-sm bg-black/10 p-4 rounded-lg border border-white/5">
              Helping organizations and individuals harness the power of
              artificial intelligence through practical consulting, tailored
              training, and engaging public speaking.
            </p>
          </motion.div>
