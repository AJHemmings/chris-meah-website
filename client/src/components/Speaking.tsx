...
const Speaking = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="speaking"
      className="py-20 relative z-10 text-white"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <h3 className="font-['Inter'] font-semibold text-2xl mb-4 text-primary">
              Expert AI Speaker
            </h3>
            <p className="text-gray-600 mb-4">
              I deliver engaging, accessible talks on artificial intelligence
              for audiences ranging from corporate executives to conference
              attendees and educational institutions.
            </p>
            <p className="text-gray-600 mb-6">
              My speaking style combines technical expertise with practical
              insights, ensuring that complex AI concepts are made accessible
        ...
        >
          <h3 className="font-['Inter'] font-semibold text-2xl mb-6 text-primary text-center">
